			...
			<td>
				<table id="header" cellpadding="10" cellspacing="0" align="center" bgcolor="8fb3e9">
					<tr>
						...
						<h1><img src="example.com/logo.png" alt="Logo" ></h1></td>
					</tr>
					<tr>
						<td width="570" bgcolor="B4B4B4" ><h2 style="color:#ffffff!important"><?php echo $subject; ?></h2></td>
					</tr>
					<tr>
						<td width="570" align="right" bgcolor="eaeaea" style="color:#999!important">
						<p><?php echo date('M Y'); ?></p></td>
					</tr>
				</table><!-- header -->
			</td>
		</tr><!-- header -->
